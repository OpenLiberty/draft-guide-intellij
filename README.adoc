...
[hotspot=httpEndpoint file=0]`<HttpEndpoint/>` and [hotspot=webApplication file=0]`contextRoot` are added in the replaced file to connect to the liberty server.
