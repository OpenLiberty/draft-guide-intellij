...
the `Port` field and `Check` in the `Name` field. Click `OK` to save the changes. From the menu bar, select `Debug` and click `Check` in the pop-up window to start the debugger.
