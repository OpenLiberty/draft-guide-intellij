...
:page-seo-title: Using IntelliJ IDEA with the Open Liberty Tools extension to develop a RESTful Java microservice
:page-seo-description: A getting started tutorial with examples on how to use IntelliJ IDEA with the Open Liberty Tools extension to develop a RESTful Java microservice with Open Liberty
...
Learn how to use the IntelliJ IDEA with the Open Liberty Tools extension to develop a microservice with Open Liberty.

## Project Description

Note: This section is for design purpose and it would be removed after the review.

### What you’ll learn
Introduce IntelliJ and use Open Liberty Tools with Intellij to build and test a simple REST service.
...
Option 1: Create a Liberty project, the start directoy should have the basic application (rest intro guide), ask users to import the maven project and gradle project from the start directory.

Option 2: Use the intellij plugin of https://start.microprofile.io/[Microprofile Starter]. Ask user to install microprofile starter and generate microProfile maven project.
...
1. Create and update both Maven project and Gradle project from the start directory.
1. Updating the context root of the microservice -> configuration

Try creating both gradle settings and `pom.xml` in the start directory.

Option 2:

1. Start the dev mode.
1. Updateing the context root of the microservice -> configuration
...
1. Use Open Liberty Tools for Intellij to test the application
1. Use Open Liberty Tools for Intellij to stop the application after the testing.

### What's the next
Developing Gradle project with libertyDev task of the Liberty Gradle Plugin.

### Brief description of application

Create system service from the rest intro guide
