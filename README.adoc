...
Create a Liberty project, the start directoy should have the basic application (rest intro guide), ask users to import the maven project from the start directory

### Developing the microsevice

1. Start the dev mode.
1. Create class(es) or update class(es) -> java
