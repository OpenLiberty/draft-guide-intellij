...
:page-releasedate: 2020-08-28
:page-description: Learn how to use IntelliJ IDEA to develop a microservice with Open Liberty.
:page-seo-title: Developing Java microservices with Open Liberty using IntelliJ IDEA
:page-seo-description: A getting started tutorial with examples on how to use the IntelliJ IDEA integrated development environment (IDE) with the Open Liberty Tools plugin to develop Java microservices with Open Liberty.
:guide-author: Open Liberty
:page-tags: []
:page-related-guides: ['rest-client-java', 'rest-intro']
...
= Developing Java microservices with Open Liberty using IntelliJ IDEA

[.hidden]
NOTE: This repository contains the guide documentation source. To view the guide in published form, view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website].

Learn how to develop Java microservices with Open Liberty using IntelliJ IDEA with the Open Liberty Tools plugin

## Design Review

NOTE: This section is for design review purpose and it will be removed after the review. 
Please review the title, desciption, SEO metadata, and the following outlines.

### What you’ll learn
- Introduce IntelliJ IDEA and Open Liberty Tools plugin
- Learn how to build and test a simple REST service using Intellij.

### Additional prerequisite
- Installation instructions of IntelliJ IDEA

### Getting started
- Clone the repository and use start and finish directory to run the project.

### Importing project to Intellij IDE
1. Proposal One: 
  - Create a Liberty project
  - the start directoy should have the basic application (from the rest intro guide)
  - ask users to import the maven project and gradle project from the start directory

2. Proposal Two: 
  - Use the intellij plugin of https://start.microprofile.io/[Microprofile Starter]
  - Ask users to install microprofile starter and generate microProfile maven project

### Developing the microsevice
- Start the dev mode.
- Update/Write the application.
- Updating the context root of the microservice -> configuration

### Running the application
- Run the application and check the result.

### Debugging the microservice
- Debug the program. After you run `Develop start` you can attach the IntelliJ IDEA debugger to the Open Liberty process.

### Testing the microservice
- Use Open Liberty Tools for Intellij to test the application
- Use Open Liberty Tools for Intellij to stop the application after the testing.

### What's the next
- Optional: Ask users to develop by gradle project with libertyDev task of the Liberty Gradle Plugin.

_End of Design Review_
...
You developed a Java microservice in Open Liberty using IntelliJ IDEA.
