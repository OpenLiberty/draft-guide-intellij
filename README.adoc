...
Proposal 1: Create a Liberty project, the start directoy should have the basic application (from the rest intro guide), ask users to import the maven project and gradle project from the start directory.

Proposal 2: Use the intellij plugin of https://start.microprofile.io/[Microprofile Starter]. Ask user to install microprofile starter and generate microProfile maven project.
